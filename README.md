...
|:---|:---|:---|
| **💹 InvestSmart** | A comprehensive Stock Portfolio Tracker helping users manage investments efficiently. | `JavaScript` `REST API` `MySQL` |
| **🛒 CivicaCart** | Smart E-commerce Platform with robust backend and user-friendly interface. | `Node.js` `DBMS` `Express` |
| **📑 RiskAnalyzer** | AI-powered Contract Risk Analyzer to detect potential legal pitfalls. | `Python` `Streamlit` `NLP` |
| **📚 FlashLearn** | Interactive Digital Flashcards app to boost retention and learning speed. | `JavaScript` `localSchema` |
| **🔬 V-Labs Builder** | An AI Virtual Lab Generator for educational institutions. | `Python` `Flask` `OpenAI API` |
